		...
		<?php
			if (isset($_POST['idPelicula'])) {
				...
				if (isset($pelicula)) {
					...
					echo '<h3 class="card-title text-secondary p-2" style="background-color: rgba(0,0,0,0.7)">Titulo: <span class="text-white">' . $pelicula->title . ' </span><p>Duración: <span class="text-white">' . $pelicula->runtime . ' \'</span></p></h3>';
