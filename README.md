<h1>Proyecto en PHP del ciclo de Desarrollo de Aplicaciones Web.</h1>
<h3>De momento solo es compatible con ngix</h3>
<h2>Necesitarás las api-key de TheMovieDatabase.org, GoogleMaps y OpenWeather</h2>
